        ...
        if 0:#for xiongmao
            ...
            for roidb_i, roidb_list in enumerate(roidb0):
                ...
                if roidb_list['gt_classes'][0] == 5:
                    num_list[4].append(roidb_list)
                if roidb_list['gt_classes'][0] == 6:
                    num_list[5].append(roidb_list)
                if roidb_list['gt_classes'][0] == 7:
                    num_list[6].append(roidb_list)
                if roidb_list['gt_classes'][0] == 8:
                    num_list[7].append(roidb_list)
            num_list_num = [len(num_list[0]),len(num_list[1]),len(num_list[2]), \
                            len(num_list[3]),len(num_list[4]),len(num_list[5]),\
                            len(num_list[6]),len(num_list[7])]
            print(num_list_num)
            num_max = max(num_list_num)
