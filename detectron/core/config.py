...
__C.TRAIN.GAUSSIAN_SIGMAX = 1.5

# Do Contrast_and_Brightness
__C.TRAIN.CAB = 0.1
__C.TRAIN.ALPHA = 0.7
__C.TRAIN.GAMMA = 0
...
# infer roi region
__C.TEST.ROI_REGION = [(0, 0.7, 0, 0.7), (0.3, 1, 0, 0.7), (0, 0.7, 0.3, 1), (0.3, 1, 0.3, 1),(0.2,0.8,0.2,0.8)] 
__C.TEST.ROI_SCALE = 0.5
__C.TEST.ROI_IOU = 0.2
